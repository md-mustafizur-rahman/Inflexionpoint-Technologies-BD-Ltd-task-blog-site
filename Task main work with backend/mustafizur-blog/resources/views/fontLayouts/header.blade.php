              ...
              <div class="container-fluid">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                          <li class="nav-item">
                              <a style="font-weight: bold;" class="nav-link" aria-current="page" href="{{route('page.home')}}">Home</a>
                          </li>
                          <li class="nav-item">
                              <a style="font-weight: bold;" class="nav-link" href="{{ route('page.bloglistByCategory', ['category' => 'tech']) }}">Tech</a>


                          </li>
                          <li class="nav-item">
                              <a style="font-weight: bold;" class="nav-link" href="{{ route('page.bloglistByCategory', ['category' => 'education']) }}">Education</a>

                          </li>
                          <li class="nav-item">
                              <a style="font-weight: bold;" class="nav-link" href="{{ route('page.bloglistByCategory', ['category' => 'business']) }}">Business</a>
                          </li>
                      </ul>
                      <form class="d-flex" role="search" method="GET" action="{{route('page.bloglist')}}">
                          @csrf
